<h2>💻 Simple CRUD Node.js API made with Typescript.</h2>
</br>🔹 Express.js;
...
<i>Note: You must have Node.js, MySQL and Redis installed on your machine. I recommend using Docker to run both storage tools.</i>
